  ...
  return (
    <div>
      ...
      <div className="lg:grid-cols-2 md:grid-cols-2 grid grid-cols-1">
        <div className="flex flex-col lg:pl-20 md:pl-20 justify-center">
          <div>
            <div className="lg:text-6xl md:text-4xl sm:text-3xl text-2xl lg:text-left md:text-left text-center flex flex-col gap-4 font-spacegrotesksemibold">
              <div>
            ...
            <div className="lg:hidden md:hidden flex justify-center mt-10">
              <img src={Mic} />
            </div>
            <div className="lg:text-xl md:text-xl text-lg font-spacegroteskregular my-10 text-center lg:text-start md:text-start p-1 lg:p-0 md:p-0">
              Our goal is to empower individuals with speech challenges. Unlock
              your potential through personalized speech training.
            </div>
          </div>

          <div className="flex flex-col lg:flex-row md:flex-row sm:flex-row gap-8 sm:justify-center md:justify-start">
      ...
      <div>
        <div className="flex items-center justify-center lg:block md:block">
          <div className="border-y-4 lg:mt-36 md:mt-32 sm:mt-14 mt-16 font-spacegrotesksemibold border-black font-medium lg:text-4xl md:text-3xl sm:text-2xl text-2xl w-fit lg:ml-20 md:ml-20 text-center">
            Features
          </div>
        </div>
        ...
        <div className="">
          <div className="flex flex-wrap items-center justify-center gap-8 p-10">
            <div className="bg-[#2D8CFF] rounded-3xl p-6 shadow-2xl lg:h-64 lg:w-96 md:h-64 md:w-96">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-2xl lg:h-64 lg:w-96 md:h-64 md:w-96">
              <div className="flex items-center justify-center lg:items-start lg:justify-start md:items-start md:justify-start">
                <img
                  src={Progress}
                  alt=""
      ...
      <div>
        <div className="flex items-center justify-center lg:block md:block">
          <div className="border-y-4 p-1 lg:mt-36 md:mt-32 sm:mt-14 mt-16 font-spacegrotesksemibold border-black font-medium lg:text-4xl md:text-3xl sm:text-2xl text-2xl w-fit lg:ml-20 md:ml-20 text-center">
            Strengths
          </div>
        </div>
        ...
        <div>
          <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1">
            <div className="lg:ml-20 md:ml-20 flex flex-col gap-8 items-center justify-center">
              <div className="lg:hidden md:hidden flex justify-center items-center mt-10">
                <img src={RealTIme} alt="" className="h-[200px]" />
              </div>
          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="lg:ml-20 md:ml-20 ml-0 flex flex-col gap-8 items-center justify-center lg:mt-0 md:mt-0 mt-10">
              <div className="lg:text-4xl md:text-3xl text-xl p-1 lg:p-0 md:p-0 lg:text-start md:text-start text-center font-spacegrotesksemibold">
                Real-Time Speech Detection and Weekly Test Analysis
              </div>
              <div className="font-spacegroteskregular lg:text-xl md:text-xl text-sm lg:text-start md:text-start text-center p-4 lg:p-0 md:p-0">
        ...
        <div className="bg-[#F3F3F3] lg:my-32 md:my-32 my-10 mx-4 md:mx-32 rounded-3xl">
          <div className="grid lg:grid-cols-2">
            <div className="text-center p-10 flex flex-col items-start justify-center gap-6">
              ...
              <div className="font-spacegroteskregular lg:text-lg md:text-lg text-sm lg:text-start md:text-start text-center">
              ...
              <div className="flex justify-center items-center w-full lg:justify-start md:justify-start">
            ...
            <div>
              <div className="lg:p-8 md:p-8 p-2">
                <div className="flex items-center justify-center">
                  <div className="font-spacegroteskmedium lg:text-4xl md:text-3xl hidden lg:block md:block">
                    Connect With Us
                  </div>
                </div>
                <div>
